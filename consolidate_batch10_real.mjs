...
const cohortFiles = [
  'gear-research/batch10/cohort1.json',
  'gear-research/batch10/cohort2.json',
  'gear-research/batch10/cohort3.json',
];
...
const migrationContent = `-- Gear audit batch 10 (real route IDs verified against live DB): 50 routes across 30 areas
...
const outPath = path.join(__dirname, 'supabase/migrations/0040_gear_audit_batch_10_real.sql');
