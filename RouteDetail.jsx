...
function SuggestFix({route,onClose,onSubmit,onLog,scrollTo,pending,peakCoord,prefill}){
  ...
  const OBJ_KEYS={road:ROAD_KEYS,access:ACCESS_KEYS,timing:TIMING_KEYS};
  ...
  const OBJ_STATE={road:[road,setRoad],access:[access,setAccess],timing:[timing,setTiming]};
