...
import { ROAD_KEYS, ACCESS_KEYS, TIMING_KEYS, CROWDS_KEYS, PARTNER_KEYS, SEASONAL_KEYS, EMERGENCY_KEYS, LOGISTICS_KEYS, DIFFICULTY_KEYS } from "./lib/objKeys.js";
...
/* A sub-key may be DOTTED (`fitnessSpec.hiking`). partner_requirements.fitnessSpec is an
  ...
  const OBJ_KEYS={road:ROAD_KEYS,access:ACCESS_KEYS,timing:TIMING_KEYS,crowds:CROWDS_KEYS,partnerRequirements:PARTNER_KEYS,seasonalGuidance:SEASONAL_KEYS,emergency:EMERGENCY_KEYS,approachLogistics:LOGISTICS_KEYS,difficulty:DIFFICULTY_KEYS};
/* An enum row stores the CODE the column already holds (solitudeRating is a number 1-5 on
  ...
  const difficultyCur=objCur(DIFFICULTY_KEYS);const crowdsCur=objCur(CROWDS_KEYS),partnerCur=objCur(PARTNER_KEYS),seasonalCur=objCur(SEASONAL_KEYS),emergencyCur=objCur(EMERGENCY_KEYS),logisticsCur=objCur(LOGISTICS_KEYS);
