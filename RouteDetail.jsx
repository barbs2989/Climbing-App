...
import { trackIsJustTheWaypoints, WAYPOINT_LINE_CAVEAT, waypointsAreOnOneLine, SYNTHETIC_WAYPOINT_CAVEAT } from "./lib/track";
...
function WaypointList({waypoints,onFocus,emptyCopy,onAdd}){
  ...
  const anyPlaced=waypoints.some(function(w){return w&&w.lat!=null&&w.lng!=null;});
