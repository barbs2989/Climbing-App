...
function WaypointList({waypoints,onFocus,emptyCopy,onAdd}){
  ...
  return <>{waypoints.map((wp,i)=>{
    ...
    const placed=wp.lat!=null&&wp.lng!=null&&Number.isFinite(Number(wp.lat))&&Number.isFinite(Number(wp.lng));
