...
- **scripts/oneoff/alpine-traverses-tier2-import.mjs** - Database import script
...
3. **Run import script** - `node scripts/oneoff/alpine-traverses-tier2-import.mjs`
...
- scripts/oneoff/query_watch_out_comprehensive.mjs - Verification script
