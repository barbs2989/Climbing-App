...
function routeMatches(r, f) {
  ...
  // WI / M / A-C ranges read that scale's own column (0199), since a route can carry several grades
  // at once; a row downloaded before 0199 has no such column, so it falls back to its primary grade
