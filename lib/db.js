...
const PARTNER_COLS = "id,name,username,avatar,bio,location,disciplines,sport_grade,trad_grade,boulder_grade,show_name";
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { data: profs, error: pErr } = await supabase
        .from("profiles").select("id, name, username, avatar, location, show_name").in("id", others);
      if (pErr) throw pErr;
      const byId = {};
