...
// Report a photo (0153). Files into content_reports, whose SELECT policy an admin can read --
// which is the whole reason it is not user_reports, see 0153's header.
//
...
// which cascades the report away with it (0153) -- so there is no state to forget to clear.
