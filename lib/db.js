...
export function dbRouteToCamel(r) {
  ...
  return {
    ...
    gainFt: r.gain_ft, lossFt: r.loss_ft, distKm: r.dist_km, maxAngle: r.max_angle,
    objHaz: r.obj_haz, elevPts: r.elev_pts, gpxPts: r.gpx,
    alpineGrade: r.alpine_grade, rockGrade: r.rock_grade, iceGrade: r.ice_grade,highPointFt:r.high_point_ft,aidGrade:r.aid_grade,descentText:r.descent_text,pitchDetail:r.pitch_detail,
  };
}
