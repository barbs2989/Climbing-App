...
export function useSubtreeRoutes(areaId, { q, disc, minGrade, maxGrade, minStars, minPitches, minLengthM, maxLengthM, sortBy, page = 0, pageSize = 40 } = {}) {
  return useQuery({
    ...
    queryFn: () => orOfflineExact(async () => {
      ...
      if (error) throw error;
      return data;
    }, () => offlineSubtreeRoutes(areaId, { q, disc, minGrade, maxGrade, minStars, minPitches, minLengthM, maxLengthM, sortBy, page, pageSize })),
  });
}
...
export function useSubtreeRouteCount(areaId, { q, disc, minGrade, maxGrade, minStars, minPitches, minLengthM, maxLengthM } = {}) {
  return useQuery({
    ...
    queryFn: () => orOfflineExact(async () => {
      ...
      if (error) throw error;
      return data;
    }, () => offlineSubtreeRouteCount(areaId, { q, disc, minGrade, maxGrade, minStars, minPitches, minLengthM, maxLengthM })),
  });
}
