...
export function dbRouteToCamel(r) {
  ...
  return {
    ...
    timing:r.timing, detailedRack:r.detailed_rack, whatToBring:toArr(r.what_to_bring), proTips:toArr(r.pro_tips), watchOut:toArr(r.watch_out), proNeeds:r.pro_needs, bestSeason:r.best_season,
  };
}
