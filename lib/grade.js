...
/* What the approval path calls: proposal grade + discipline -> the sortable number.
   ...
   Known gap accepted on those grounds — a bare ordinal (`"4th"`, `"3rd"`, `"Easy 5th"`) scores
   null here because the ordinal branch requires the word "class". ~40 WA rows are shaped that
   way. Fix it in the pipeline for all five copies, not here for one. */
