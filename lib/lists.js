...
//
//     Cascade volcanoes   14 of 18      California 14ers    11 of 12
//     Colorado 14ers      11 of 53      State highpoints     9 of 50
//
// The two weak ones are weak for a reason worth keeping. COLORADO's tree is a CRAG tree, not a
// peak tree: Longs Peak, Mount Elbert, Grays Peak and Pikes Peak have no area at all, because a
// walk-up fourteener is not a rock-climbing area in the OpenBeta source. STATE HIGHPOINTS are
...
export const STATE_HIGHPOINT_PEAKS = [
  { id: "ak_denali", name: "Denali", ft: 20310 },
  { id: "ca_mt_whitney", name: "Mount Whitney", ft: 14505 },
  { id: "de_ebright_azimuth", name: "Ebright Azimuth", ft: 449 },
  { id: "mt_granite_peak", name: "Granite Peak", ft: 12807 },
  { id: "nh_mount_washington", name: "Mount Washington", ft: 6285 },
  { id: "or_mt_hood", name: "Mount Hood", ft: 11249 },
  { id: "vt_mt_mansfield", name: "Mount Mansfield", ft: 4395 },
  { id: "wa_mount_rainier", name: "Mount Rainier", ft: 14411 },
  { id: "wy_gannett_peak", name: "Gannett Peak", ft: 13809 },
];
...
// with routes on it. A walk-up fourteener is not, which is why Colorado manages 12 of 53.
//
// The advertised 30 is not canonical (no published roster fixes it), same caveat as the Cascade
// 18. Three do not resolve: Determination Tower, Eagle Rock Spire, Corral Spire.
...
export const NP_HIGHPOINT_PEAKS = [
  { id: "ak_denali", name: "Denali", ft: 20310 },
  { id: "ak_mount_saint_elias", name: "Mount Saint Elias", ft: 18008 },
  { id: "ak_mount_fairweather", name: "Mount Fairweather", ft: 15325 },
  { id: "ca_mt_whitney", name: "Mount Whitney", ft: 14498 },
  { id: "wa_mount_rainier", name: "Mount Rainier", ft: 14411 },
  { id: "ca_north_palisade", name: "North Palisade", ft: 14242 },
  { id: "wy_grand_teton", name: "Grand Teton", ft: 13770 },
  { id: "ca_mt_lyell", name: "Mount Lyell", ft: 13114 },
  { id: "nv_wheeler_peak", name: "Wheeler Peak", ft: 13063 },
  { id: "wa_mount_goode", name: "Goode Mountain", ft: 9200 },
  { id: "wa_mount_olympus", name: "Mount Olympus", ft: 7969 },
  { id: "ut_elephant_butte", name: "Elephant Butte", ft: 5653 },
];
...
export const PEAK_ROSTERS = {
  ...
  co14: CO_14ER_PEAKS,
  ca14: CA_14ER_PEAKS,
  state_hp: STATE_HIGHPOINT_PEAKS,
  cascade: CASCADE_VOLCANO_PEAKS,
  desert: DESERT_TOWER_PEAKS,
  np_hp: NP_HIGHPOINT_PEAKS,
};
