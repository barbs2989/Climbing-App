...
const cohortFiles = [
  'gear-research/batch6/cohort1.json',
  'gear-research/batch6/cohort2.json',
  'gear-research/batch6/cohort3.json',
];
...
const migrationContent = `-- Gear audit batch 6 (real route IDs verified against live DB): 50 routes across 20 areas
