...
the batch files listed in your task message (under <AUDIT_DIR>/batches/)
...
## Output
Write ONE JSON file to the output path given in your task message with this shape and nothing else:
```
