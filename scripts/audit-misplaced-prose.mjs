...
const cols = "id,fa,grade,season,aspect,commitment,alpine_grade,rock_grade,ice_grade,aid_grade,face,permit,comms,turnaround,pro_needs,detailed_rack,rope_type,rope_note,rappel_count_note,rappels,best_season,bail,descent,descent_text,approach,overview,beta,gear,hazards,obj_haz,what_to_bring,pro_tips,watch_out,timing,access,road,crowds,emergency,climate,itinerary,partner_requirements,seasonal_guidance,seasonal_hazards,approach_logistics,approach_variants,climbing_route,bivy,pitch_detail,waypoints,rappel_detail";
