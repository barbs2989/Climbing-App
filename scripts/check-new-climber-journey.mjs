...
try {
  ...
  //
  // The mate is NOT reachable through partner browse: listing defaults ON since `0192`, but the
  // CI fixture accounts are written `discoverable=false` and `0192` leaves them so, and
