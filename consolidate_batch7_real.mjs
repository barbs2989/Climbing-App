...
const cohortFiles = [
  'gear-research/batch7/cohort1.json',
  'gear-research/batch7/cohort2.json',
  'gear-research/batch7/cohort3.json',
];
...
const migrationContent = `-- Gear audit batch 7 (real route IDs verified against live DB): 50 routes across 41 areas
...
const outPath = path.join(__dirname, 'supabase/migrations/0037_gear_audit_batch_7_real.sql');
