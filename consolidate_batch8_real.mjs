...
const cohortFiles = [
  'gear-research/batch8/cohort1.json',
  'gear-research/batch8/cohort2.json',
  'gear-research/batch8/cohort3.json',
];
...
const migrationContent = `-- Gear audit batch 8 (real route IDs verified against live DB): 50 routes across 41 areas
...
const outPath = path.join(__dirname, 'supabase/migrations/0038_gear_audit_batch_8_real.sql');
