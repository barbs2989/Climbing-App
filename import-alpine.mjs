...
(function preflight() {
  ...
  const DISC = new Set(["alpine","mountaineering","scrambling","scramble","hike","ice","mixed","rock","trad","sport","aid","bouldering","tr"]);
  const issues = [];
  A.forEach(a => {
